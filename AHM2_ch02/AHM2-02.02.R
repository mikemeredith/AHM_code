...
plot(table(counts), frame = FALSE, main = 'MHB Green Woodpecker Counts', type = 'h',
  lend = 'butt', lwd = 10)
hist(dateso, main = 'Julian Dates (start on week-end around April 15)', breaks = 50,
  col = 'grey')
hist(timeso, main = 'Survey duration (min)', breaks = 50, col = 'grey')
hist(into, main = 'Survey intensity (min / km route length)', breaks = 50, col = 'grey')
