...
legend('topright', legend = c('True psi', 'Obs. psi', 'Estimated psi (unmarked)',
    'Estimated psi (JAGS)'), col = c('red', 'black', 'green', 'blue'), lty = 1, lwd = 3, bty = 'n')
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
if(packageVersion("unmarked") >= '1.0.0.9008') { # needs patched version of unmarked
  ...
  with(E.ext, { # simplify requesting columns of the data frame returned by predict
     ...
     segments(((1:9)+0.1), (1-out2$summary[11:19,3]), ((1:9)+0.1), (1-out2$summary[11:19,7]), col = "blue", lwd = 1)
  })
  ...
  with(E.col, {
     ...
     segments(((1:9)+0.1), out2$summary[20:28,3], ((1:9)+0.1), out2$summary[20:28,7], col = "blue", lwd = 1)
  })
  ...
  with(E.det, {
     ...
     segments(((1:10)+0.1), out2$summary[29:38,3], ((1:10)+0.1), out2$summary[29:38,7], col = "blue", lwd = 1)
